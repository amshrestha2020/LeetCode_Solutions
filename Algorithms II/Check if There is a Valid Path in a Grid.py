...
class Solution:
    def hasValidPath(self, grid: List[List[int]]) -> bool:
        ...
        # Define connections based on street type
        directions = {
        ...
        def dfs(x, y):
            ...
            for dx, dy, valid_streets in directions[grid[x][y]]:
                nx, ny = x + dx, y + dy
                if 0 <= nx < m and 0 <= ny < n and not visited[nx][ny] and grid[nx][ny] in valid_streets:
                    if dfs(nx, ny):
                        return True
