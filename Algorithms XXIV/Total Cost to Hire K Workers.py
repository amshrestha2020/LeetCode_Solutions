...
class Solution:
    def totalCost(self, costs: List[int], k: int, candidates: int) -> int:
        ...
        # Track the first candidates workers (left) and last candidates workers (right)
        left = 0
        right = n - 1
        
        # Fill initial heaps from both ends
        ...
        total_cost = 0
        for _ in range(k):
            # Choose the best (smallest) cost from both heaps
