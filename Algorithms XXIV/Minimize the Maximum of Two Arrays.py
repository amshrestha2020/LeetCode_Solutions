...
class Solution:
    ...
    def minimizeSet(self, divisor1: int, divisor2: int, uniqueCnt1: int, uniqueCnt2: int) -> int:
        low = 1
        high = int(1e10)  # Using a large number as the upper bound
        count1 = 0
        count2 = 0
        common = 0
        ...
        while low < high:
            ...
            common = mid - (mid // self.lcm(divisor1, divisor2))

            if count1 >= uniqueCnt1 and count2 >= uniqueCnt2 and common >= uniqueCnt1 + uniqueCnt2:
                high = mid
            else:
                low = mid + 1
