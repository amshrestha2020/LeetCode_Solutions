...
class Solution:
    def countPaths(self, n: int, roads: List[List[int]]) -> int:
        ...
        while pq:
            ...
            # If we reach the target and the current time exceeds the shortest known time, we skip it
            ...
            for v, time in graph[u]:
                ...
                if new_time < min_time[v]:
                    min_time[v] = new_time
                    path_count[v] = path_count[u]  # update path count
                    heappush(pq, (new_time, v))
                elif new_time == min_time[v]:
                    path_count[v] = (path_count[v] + path_count[u]) % MOD  # add paths
