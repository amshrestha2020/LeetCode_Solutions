...
class Solution:
    def numberOfWeeks(self, milestones: List[int]) -> int:
        ...
        # Count how many projects have the maximum number of milestones
        max_count = milestones.count(max_milestone)
        
        # If the max milestones are more than the total other milestones
